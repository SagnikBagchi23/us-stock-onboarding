# Groww Design System — Color Tokens

> **Status:** Alpha · v0.18
> **Scope:** Color tokens — Primitives, Neutrals, Colour Roles, Brand Semantics, Data Viz, Background, Content, Border
> **Brands:** Groww · 915 · W
...
Alias tokens that give each brand its accent identity. Token names are shared — only the primitive reference changes per brand. Switch brands in the sandbox to preview each brand's resolved colors.

### Brand → Accent Hue Mapping

| Brand | Accent | Accent Secondary |
|-------|--------|-----------------|
| `groww-invest` | `hues/green` | `hues/blue` |
| `groww-credit` | `hues/green` | `hues/lilac` |
| `W` | `hues/gold` | `hues/gold` |
| `groww-mf-prime` | `hues/blue` | `hues/green` |
| `915` | `hues/green` (base) · `hues/915 green` (dark interaction) | `hues/blue` |

### 4.1 Accent Tokens

The step pattern below applies to all brands — substitute `{hue}` with the brand's accent hue.

**Base**

| Token | Light reference | Dark reference |
|-------|----------------|----------------|
| `accentEmphasize` | `hues/{hue}/light/11` | `hues/{hue}/dark/11` |
| `accentBase` | `hues/{hue}/light/09` | `hues/{hue}/dark/09` |
| `accentSubtle` | `hues/{hue}/light/02` | `hues/{hue}/dark/02` |
| `accentSubtleOnSurfaceZ1` | `hues/{hue}/light/02` | `hues/{hue}/dark/02` |
| `accentSubtleOnSurfaceZ2` | `hues/{hue}/light/02` | `hues/{hue}/dark/03` |

**Interaction States**

| Token | Light reference | Dark reference |
|-------|----------------|----------------|
| `accentBaseHover` | `hues/{hue}/light/10` | `hues/{hue}/dark/10` |
| `accentBaseSelected` | `hues/{hue}/light/10` | `hues/{hue}/dark/10` |
| `accentSubtleHover` | `hues/{hue}/light/03` | `hues/{hue}/dark/03` |
| `accentSubtleSelected` | `hues/{hue}/light/03` | `hues/{hue}/dark/03` |
| `accentSubtleHoverOnSurfaceZ1` | `hues/{hue}/light/03` | `hues/{hue}/dark/03` |
| `accentSubtleSelectedOnSurfaceZ1` | `hues/{hue}/light/03` | `hues/{hue}/dark/03` |
| `accentSubtleHoverOnSurfaceZ2` | `hues/{hue}/light/03` | `hues/{hue}/dark/04` |
| `accentSubtleSelectedOnSurfaceZ2` | `hues/{hue}/light/03` | `hues/{hue}/dark/04` |

> **915 dark interaction states** use `hues/915 green/dark/{step}` instead of `hues/green/dark/{step}`.

### 4.2 Accent Secondary Tokens

Same step pattern as accent — substitute `{hue}` with the brand's accent secondary hue.

Token names follow the same structure with `accentSecondary` prefix (e.g., `accentSecondaryBase`, `accentSecondarySubtleHoverOnSurfaceZ2`).
